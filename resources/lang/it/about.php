...
return [
    ...
    'roc' => 'Sono uno studente normele e un grande fan dell\'NBA. Mi piace la pizza e la Nutella.',
    'about_castel' => 'È un ragazzo molto bravo e un amico molto divertente. Gli piace studiare e quando lo fa ottiene ottimi risultati. Litiga sempre con Luana e a volte si arrabbia con lei e fa il "preso male".',
    'about_nich' => 'È un ragazzo molto tranquillo ma un amico molto leale. Gli piace giocare a pallacanestro
                                ed è molto bravo. La sua arma segreta è l\'inarrestabile "jump hook". Nessuno
                                lo sa ma è segretamente innamorato di Lebron James.',
    'about_roc' => 'È un ragazzo molto entusiasta e quando ha una giornata molto lunatico. Lui è fan da una vita
                                 di Kobe e batte sempre Nicholas al Dunkest. Ha smesso di giocare a basket ma nella sua ultima stagione
                                ha vinto il trofeo della "Seconda divisione bergamasca".', 
];